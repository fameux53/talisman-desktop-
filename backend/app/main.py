...
def create_app() -> FastAPI:
    ...
    # NOTE: HTTPSRedirectMiddleware removed — Railway's reverse proxy already
    # handles TLS termination.  Internal healthcheck probes arrive over plain
    # HTTP, so the middleware was causing 307 redirects on /health.
